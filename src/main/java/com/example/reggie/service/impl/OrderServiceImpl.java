...
public class OrderServiceImpl extends ServiceImpl<OrderMapper, Orders> implements OrderService {
    ...
    public void submit(Orders orders) {
        ...
        AtomicInteger amount = new AtomicInteger(0); // 累计总金额，原子操作
    ...
    @Override
    public Page getByUserIdWithOrderDetails(int page, int pageSize) {
        Long userId = BaseContext.getCurrentId();
        ...
        orderWrapper.orderByAsc(Orders::getStatus);
        orderWrapper.orderByDesc(Orders::getOrderTime);
    ...
    @Override
    public OrdersDto getByIdWithOrderDetails(Long id) {

        // 先查询订单
        LambdaQueryWrapper<Orders> orderWrapper = new LambdaQueryWrapper();
        orderWrapper.eq(Orders::getId, id);
        Orders one = this.getOne(orderWrapper);
